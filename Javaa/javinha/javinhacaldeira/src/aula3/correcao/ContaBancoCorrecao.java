...
//Exercício corrigido pelos professores.
public class ContaBancoCorrecao {
         ...
         */
        public ContaBancoCorrecao(String nome, String cpf, String identificadorConta, String banco, String endereco) {
            this.nome = nome;
         ...
         */
        public void transferencia(ContaBancoCorrecao destino, double valor) {
            if (contaEstaAtiva()) {
